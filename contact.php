	...
	<body class="is-preload">
						...
						<div id="content">
							...
							<!-- Content -->
								...
								<article>
									...
									<div class="style2" id='formContainer'>

										Name: <input type="text" placeholder="First and Last Name">

										Email: <input type='email' placeholder="example@gamil.com">

										Message: <textarea placeholder="Start Typing Here"></textarea>
		...
		<!-- Scripts -->
			...
			<script type="text/javascript">
				...
				// Anime function for form 
				anime({
					targets: document.getElementById('formContainer'),
					easing: 'linear',
					opacity: [0, 1],
					translateY: [100, 0],
					duration: 1000
				...
				// Anime function for title of page 
				anime({
					targets: document.getElementById('contactus'),
					easing: 'linear',
					opacity: [0, 1],
					translateX: [-100, 0],
					duration: 1000
